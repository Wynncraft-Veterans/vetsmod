 ...
 *
 * <p>Init order: call {@link #init()} from
 * {@code VetsmodClient.onClientStarted} (the
 * {@code ClientLifecycleEvents.CLIENT_STARTED} handler), NEVER from
 * {@code onInitializeClient} — Wynntils' {@code Models.*} access from the
