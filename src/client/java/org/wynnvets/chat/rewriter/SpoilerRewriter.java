...
public final class SpoilerRewriter {
    ...
    private static MutableComponent rebuildWithDecodedSpoilers(Component component) {
        List<NickResolver.FlatPart> fragments = new ArrayList<>();
        NickResolver.flattenComponent(component, component.getStyle(), fragments);
     ...
     */
    private static MutableComponent rebuildCrossFragmentSpoilers(
            List<NickResolver.FlatPart> fragments) {
        MutableComponent result = Component.empty();
        ...
        NickResolver.FlatPart colonFrag = fragments.get(colonFragIdx);
