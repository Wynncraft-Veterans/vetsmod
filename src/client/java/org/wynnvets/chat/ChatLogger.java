...
public class ChatLogger {
    ...
    private static final Map<String, Long> recentMessages =
            ...
            if (message.contains(rankIndicator)) {
                ...
                if (colonIndex > 0) {
                    ...
                    String messageContent =
                            stripConcatenatedContent(afterRank.substring(colonIndex + 1).trim());
    ...
    private static String createJsonLogEntry(String timestamp, ParsedMessage parsed) {
        ...
        return String.format(
                "{\"timestamp\":\"%s\",\"rank\":\"%s\",\"username\":\"%s\",\"message\":\"%s\"}",
