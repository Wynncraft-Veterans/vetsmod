...
public final class ListFetcher {
    ...
    public static CompletableFuture<MutableComponent> fetchList() {
        return OnlineMemberService.gatherOnlinePlayers().thenApply(ListFetcher::formatList);
    }
    ...
    private static MutableComponent formatList(OnlineMemberService.GatherResult result) {
        ...
        List<String> withMod =
                players.stream()
                        .filter(
                                p ->
                                        OnlineMemberService.TIER_GUILD.equals(p.tier())
        ...
        msg.append(
                Component.literal("Online Members\n")
